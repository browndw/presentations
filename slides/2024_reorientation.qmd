---
title: How Did We Get to LLMs?
subtitle: A short history and some implications for our classrooms
format: 
  clean-revealjs:
    transition: fade
html-math-method:
...
author:
  - name: David Brown
    ...
    affiliations: Writing & Communication Reorientation
date: August 21, 2024
title-slide-attributes: 
  data-background-image: img/img_2024_reorientation/2024_reorientation_qr.svg
  data-background-size: 15%
  data-background-position: 75% 70%
bibliography: refs/refs_2024_reorientation.bib
---
...
::: r-stack
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/mt_timeline_01.svg');  background-repeat: no-repeat; background-size: cover; width: 900px; height: 200px; background-position: center;"}
:::
:::
...
::: r-stack
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/mt_timeline_01.svg');  background-repeat: no-repeat; background-size: cover; width: 900px; height: 400px; background-position: left;"}
:::
:::
...
![](img/img_2024_reorientation/mt_timeline_02.png)
...
::: columns
::: {.column width="60%"}
![](img/img_2024_reorientation/weaver_memo_01.png)
:::
...
::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/weaver_memo_02.png)
:::
...
![](img/img_2024_reorientation/context_window.png)
...
::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/alpac_01.png)
:::
...
::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/alpac_02.png)
:::
...
::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/alpac_03.png)
:::
...
![](img/img_2024_reorientation/pipeline.svg)
...
readr::read_csv("data/data_2024_reorientation/brown_sampling_frame.csv") |>
  knitr::kable("html") |>
...
readr::read_csv("data/data_2024_reorientation/brown_dtm.csv", na = "NA") |> 
...
::: {data-id="scatter1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/brown_scatter.svg');  background-repeat: no-repeat; background-size: cover; width: 800px; height: 400px; background-position: left;"}
:::
:::
...
::: r-stack
::: {data-id="scatter1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/brown_scatter.svg');  background-repeat: no-repeat; background-size: cover; width: 1200px; height: 600px; background-position: left;"}
:::
...
::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/histogram_the.svg)
:::

::: {.column width="50%"}
![](img/img_2024_reorientation/histogram_data.svg)
:::
:::
...
readr::read_csv("data/data_2024_reorientation/vector_embeddings.csv", na = "NA") |> 
  knitr::kable("html", align = "r", table.attr = "style='width:90%;'") |>
...
## Emergence of ML {background-image="img/img_2024_reorientation/cos_similarity_02.png" background-size="60%" background-opacity=".5"}
...
$$ ![](img/img_2024_reorientation/cos_similarity.png)

## Emergence of ML {background-video="img/img_2024_reorientation/vector_model_01.mp4" background-video-loop="true" background-video-muted="true"}
...
## Emergence of ML {background-image="img/img_2024_reorientation/vector_model_02.png"}
...
![](img/img_2024_reorientation/llms_generations.png)
...
## Emergence of ML {background-video="img/img_2024_reorientation/bert_model_01.mp4" background-video-loop="true" background-video-muted="true"}

## Emergence of ML {background-video="img/img_2024_reorientation/bert_model_02.mp4" background-video-loop="true" background-video-muted="true"}

## Emergence of ML {background-video="img/img_2024_reorientation/bert_model_03.mp4" background-video-loop="true" background-video-muted="true"}

## Emergence of ML {background-video="img/img_2024_reorientation/bert_model_04.mp4" background-video-loop="true" background-video-muted="true"}
...
![Projection of student, published, and ChatGPT-generated writing onto the first two linear discriminants, based on the 67 Biber features.](img/img_2024_reorientation/lda_scatter.svg)
...
ld1_tbl <- readr::read_csv("data/data_2024_reorientation/ld1_tbl.csv")
...
modal_freq <- readr::read_csv("data/data_2024_reorientation/modal_freq.csv")
...
![Excerpts from texts produced by ChatGPT](img/img_2024_reorientation/gpt_excerpts_01.png){width=80%}
...
test_preds <- readr::read_csv("data/data_2024_reorientation/test_preds.csv")
...
feature_imp <- readr::read_csv("data/data_2024_reorientation/feature_importance.csv")
...
1.  ChatGPT produces sentences that are [more informationally dense]{style="background-color: #f5b2c6; opacity: 0.75;"} than that of student writing, but the information density is created using repetitive grammatical patterns.
2.  Machine-generated writing demonstrates [less modulation of stress or confidence]{style="background-color: #f5b2c6; opacity: 0.75;"}.
3.  Broadly, LLMs are [not as grammatically nimble]{style="background-color: #f5b2c6; opacity: 0.75;"} as human writers.
4.  LLM-generated text generally produces academic prose [expressing limited engagement with core, disciplinary concepts]{style="background-color: #f5b2c6; opacity: 0.75;"} either in the way that experts do or in the way that novice students do. (Though LLMs can arrive at something more like expert writing with iterative prompting.)
5.  It is a open question as to [the effects of LLMs on the development of students' disciplinary expertise]{style="background-color: #f5b2c6; opacity: 0.75;"}.
