...
![Excerpts from texts produced by ChatGPT](img/img_2024_shel/gpt_excerpts_01.png){width="80%"}
...
We also created an experiment at scale, with 10,000 samples, across 9 text-types, and querying 6 different models.
:::
:::
::::
