...
author:
  - name: David Brown
    ...
    affiliations: RSA (Three Rivers)
date: October 31, 2024
title-slide-attributes: 
  data-background-image: img/img_2024_rsa/2024_rsa_qr.svg
  data-background-size: 15%
  data-background-position: 75% 70%
bibliography: refs/refs_2024_rsa.bib
---
...
:::: r-stack
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/writing_timeline.svg');  background-repeat: no-repeat; background-size: cover; width: 900px; height: 200px; background-position: center;"}
:::
::::
...
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/writing_timeline.svg');  background-repeat: no-repeat; background-size: cover; width: 1200px; height: 300px; margin: 10px;"}
:::
::::::::
...
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/writing_timeline.svg');  background-repeat: no-repeat; background-size: cover; width: 1200px; height: 400px; margin: 10px;"}
:::
:::::
...
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/writing_timeline.svg');  background-repeat: no-repeat; background-size: cover; width: 1200px; height: 400px; background-position: right;"}
:::
:::::
...
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_reorientation/writing_timeline.svg');  background-repeat: no-repeat; background-size: cover; width: 1200px; height: 300px; margin: 10px; background-position: right;"}
:::
::::::::
...
:::::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/syg_erasers.png)
:::
...
:::::: columns
::: {.column width="50%"}
![](img/img_2024_reorientation/claxton_erasers.png)
:::
...
:::: r-stack
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_rsa/mt_timeline_01.svg');  background-repeat: no-repeat; background-size: cover; width: 900px; height: 200px; background-position: center;"}
:::
::::
...
:::: r-stack
::: {data-id="time1" auto-animate-delay="0" style="background-image: url('img/img_2024_rsa/mt_timeline_01.svg');  background-repeat: no-repeat; background-size: cover; width: 900px; height: 400px; background-position: left;"}
:::
::::
...
![](img/img_2024_rsa/mt_timeline_02.png)
...
:::::: columns
::: {.column width="60%"}
![](img/img_2024_rsa/weaver_memo_01.png)
:::
...
:::::: columns
::: {.column width="50%"}
![](img/img_2024_rsa/weaver_memo_02.png)
:::
...
![](img/img_2024_rsa/context_window.png)
...
readr::read_csv("data/data_2024_rsa/brown_sampling_frame.csv") |>
  knitr::kable("html") |>
...
readr::read_csv("data/data_2024_rsa/brown_dtm.csv", na = "NA") |> 
...
::: {data-id="scatter1" auto-animate-delay="0" style="background-image: url('img/img_2024_rsa/brown_scatter.svg');  background-repeat: no-repeat; background-size: cover; width: 800px; height: 400px; background-position: left;"}
:::
::::::::
...
::::: r-stack
::: {data-id="scatter1" auto-animate-delay="0" style="background-image: url('img/img_2024_rsa/brown_scatter.svg');  background-repeat: no-repeat; background-size: cover; width: 1200px; height: 600px; background-position: left;"}
:::
...
readr::read_csv("data/data_2024_rsa/vector_embeddings.csv", na = "NA") |> 
  knitr::kable("html", align = "r", table.attr = "style='width:90%;'") |>
...
## Emergence of ML {background-image="img/img_2024_rsa/cos_similarity_02.png" background-size="60%" background-opacity=".5"}
...
$$ ![](img/img_2024_rsa/cos_similarity.png)

## Emergence of ML {background-video="img/img_2024_rsa/vector_model_01.mp4" background-video-loop="true" background-video-muted="true"}
...
## Emergence of ML {background-image="img/img_2024_rsa/vector_model_02.png"}
...
![](img/img_2024_rsa/llms_generations.png)
...
## Emergence of ML {background-video="img/img_2024_rsa/bert_model_01.mp4" background-video-loop="true" background-video-muted="true"}

## Emergence of ML {background-video="img/img_2024_rsa/bert_model_02.mp4" background-video-loop="true" background-video-muted="true"}

## Emergence of ML {background-video="img/img_2024_rsa/bert_model_03.mp4" background-video-loop="true" background-video-muted="true"}

## Emergence of ML {background-video="img/img_2024_rsa/bert_model_04.mp4" background-video-loop="true" background-video-muted="true"}
...
:::::: columns
::: {.column width="60%"}
![](img/img_2024_rsa/hape_workflow.svg){width="100%"}
:::
...
hape_totals <- readr::read_csv("data/data_2024_rsa/hape_totals.csv")
...
-   It turns out, machine-authored prose and human-authored prose have some important differences. [@herbold2023large; @reinhart2024llms]
-   There are, for example, clear patterns in the relative frequencies of lemmatized words.

:::::: columns
::: {.column width="50%"}
![](img/img_2024_rsa/vocab-compare.png){width="60%" fig-align="top"}
:::

:::: {.column width="50%"}
::: {style="font-size: 75%; padding-top: 5px;"}
...
counts <- readr::read_csv("data/data_2024_rsa/overrepresented.csv", show_col_types = FALSE)
...
-   The over-represented words align with those noted in a study of peer reviews for a large machine learning conference. They measured an uptick of suspiciously positive words after the release of ChatGPT. [@liang2024monitoring]

![](img/img_2024_rsa/F0b_frequency_ICLR.png)
...
result <- readr::read_csv("data/data_2024_rsa/rf_accuracy.csv")
...
feature_imp <- readr::read_csv("data/data_2024_rsa/feature_importance.csv")
...
-   Carrying our principal component analysis (PCA) on the chunk 2 of the human writing, yields a first principal component (PC1) that strongly resembles [Biber's Demension 1](https://www.uni-bamberg.de/fileadmin/eng-ling/fs/Chapter_21/Index.html?23DimensionsofEnglish.html) (Involved vs. Informational Production).
...
contrib_df <- readr::read_csv("data/data_2024_rsa/variable_contrib.csv", show_col_types = FALSE)
...
![Projection of human chunk 2 writing onto the first principal component, based on the 67 Biber features.](img/img_2024_rsa/pca_human.svg)

## Implications

![Projection of human chunk 2 writing and Llama Base onto the first principal component.](img/img_2024_rsa/pca_base.svg)

## Implications

![Projection of human chunk 2 writing and Llama Instruct onto the first principal component.](img/img_2024_rsa/pca_instruct.svg)

## Implications

![Projection of human chunk 2 writing and GPT 4o onto the first principal component.](img/img_2024_rsa/pca_gpt.svg)

## Implications

-   We found similar patterns when we examined the differences between student writing and LLM-generated writing using examples for an introductory data science assignment. [@markey2024dense]

![Projection of student, published, and ChatGPT-generated writing onto the first two linear discriminants, based on the 67 Biber features.](img/img_2024_rsa/lda_scatter.svg)
...
ld1_tbl <- readr::read_csv("data/data_2024_rsa/ld1_tbl.csv", show_col_types = FALSE)
...
ld1_tbl <- readr::read_csv("data/data_2024_rsa/ld1_tbl.csv")
...
modal_freq <- readr::read_csv("data/data_2024_rsa/modal_freq.csv")
...
![Excerpts of ChatGPT-generated writing with *Noun + Noun* and *Adj. + Noun* sequences underlined in blue and other characteristic features of machine-generated writing marked in red.](img/img_2024_rsa/gpt_excerpts_01.png){width="80%"}
...
4.  Broadly, LLMs are [not as grammatically nimble]{style="background-color: #f5b2c6; opacity: 0.75;"} as human writers.
